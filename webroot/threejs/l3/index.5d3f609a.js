...
*/
var aa=__webpack_require__(1),n=__webpack_require__(5),r=__webpack_require__(8);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var routes = function () {
    return (react["createElement"](react_router_dom_HashRouter, null,
        ...
        react["createElement"](react_router_Route, { exact: true, path: "/", component: webGL(Promise.all(/* import() | l3-examples-index */[__webpack_require__.e(1), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, 49))) }),
        react["createElement"](react_router_Route, { exact: true, path: "/cube", component: webGL(Promise.all(/* import() | l3-examples-cube */[__webpack_require__.e(1), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, 50))) }),
        react["createElement"](react_router_Route, { exact: true, path: "/vertices-faces", component: webGL(Promise.all(/* import() | l3-examples-vertices-faces */[__webpack_require__.e(1), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, 51))) }),
        react["createElement"](react_router_Route, { exact: true, path: "/geometries", component: webGL(Promise.all(/* import() | l3-examples-geometries */[__webpack_require__.e(1), __webpack_require__.e(7)]).then(__webpack_require__.bind(null, 52))) })));
};
